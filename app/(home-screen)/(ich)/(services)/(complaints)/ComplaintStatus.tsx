    ...
    >
      <View className="flex-1 bg-screenBackgroundColor px-4">
        ...
        <View className="flex-row justify-center mt-3">
          <TouchableOpacity onPress={() => setActive("unresolved")} className="mx-6">
          ...
          <TouchableOpacity onPress={() => setActive("resolved")} className="mx-6">
            <View style={{ alignItems: "center" }} >
          ...
          {/* <TouchableOpacity onPress={() => setActive("transferred")} className="mx-6">
            <View style={{ alignItems: "center" }} >
              <Image
